...
import { Route, triggerDescription, RunSummaryBar, JobsCard } from "./repositories.$owner.$repo.runs.$runId.js"
...
describe("RunSummaryBar", () => {
  ...
  it("shows Artifacts label with dash", () => {
    render(<RunSummaryBar run={makeRun()} owner="acme" repo="api" />)
...
describe("JobsCard", () => {
  ...
  it("shows '…' in header when jobs is undefined", () => {
    render(<JobsCard jobs={undefined} />)
    expect(screen.getByTestId("card-header")).toHaveTextContent("Jobs (…)")
  })
